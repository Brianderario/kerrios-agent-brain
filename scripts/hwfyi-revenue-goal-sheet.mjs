...
const PIPELINE_SEED_ROWS = [
  ...
  },
  {
    ...
    evidence: "Katrina confirmed June 23 dinner and supplied ICP/list; venue/invite work active. Sponsor fee/invoice status is not recorded.",
    nextAction: "Confirm sponsor fee/invoice status and whether dinner is incremental or included before assigning value.",
  },
  {
