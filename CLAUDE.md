...
| `superhuman` (uuid `760b1f3b…`) | Brian's S/W email (brian@standardandworks.com — verified alias). list_threads, get_thread, get_message, create_or_update_draft, send_draft. S-prefix sends only — never auto-CC HWFYI. |
