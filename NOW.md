...
- Confirm templated tier prices on Zenode (A $20K/B $12K/C $5K) before send.
- ATOMS: approve/edit, or send manually from brian@hardwarefyi.com (sender-locked to Brian).
