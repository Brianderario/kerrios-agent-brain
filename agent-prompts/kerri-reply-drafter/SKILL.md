...
- **Brain:** `node scripts/brain-api.mjs search "<company / topic>"` for any durable decision, relationship fact, or playbook that applies.
...
### 3. PICK THE PLAY
Match the situation to the right canonical playbook and READ it before drafting:
