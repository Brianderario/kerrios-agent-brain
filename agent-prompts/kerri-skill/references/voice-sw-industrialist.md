...
## The dominant format ("Plus" / Tue + Thu standard issue)

### 1. Markets snapshot (top of issue)

4–5 indicators with direction arrows (▲ green, ▼ red). Observed in recent issues:

- **Aerospace & Defense ETF** (ITA): price, arrow
- **Semiconductor ETF** (SOXX): price, arrow
- **Industrials ETF** (XLI): price, arrow
...
### 3. Category roundups (5–6 sections)
...
Each section: 3 bullets. Each bullet: 1–2 sentences with an embedded link. Format:

> [Company] [verb-action] [specific number / detail]. [optional brief why-it-matters clause]. [link]

Example structure (paraphrased from observed issues):
- "BAE Systems will invest $X expanding its [Pennsylvania] munitions facility, doubling [specific output capacity]. [link]"
- "[Foundry name] raised $XM Series Y to build a [specific facility] in [state]. [link]"

Tight, scannable, every bullet must have a concrete number or a concrete commitment. No vague "is exploring" / "may consider" bullets.
...
One line. "Back Tuesday." / "Back Thursday." Nothing more.

## The long-form format (occasional, replacing or supplementing standard issue)
...
5. **Strategic framework.** What category of move is this? Parallels to other states/industries/eras when relevant.
6. **Forward action.** What's next + when.

Length: ~500–900 words. 4-min read.

Used when:
- Brian or Zach has done original reporting / interviews
