...
TOKEN BUDGET CONTRACT:
  ...
  Do NOT load: full brain/wiki directories, voice.md, NOW.md, email threads, Google Tasks.
...
2. Write a candidate page to:
   ...
   If Brian promotes this class to stage 2, Kerri would be able to send <action-class> emails without a Google Tasks approval item. Every send would still auto-CC brian@hardwarefyi.com and carry a 4-hour undo window. Any incident would auto-demote back to stage 1.
...
- This routine NEVER creates Google Tasks approval items.
