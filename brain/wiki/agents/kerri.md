...
scope: agent · updated: 2026-05-26
...
- **Runtime location:** Codex automations in `~/.codex/automations/`; legacy Claude shims may still point at the canonical prompt but are fallback-only.
...
4. **Morning brief and EOD meetings review** — active Codex automations; weekly digest remains prompt-only until Brian confirms cadence/audience.
