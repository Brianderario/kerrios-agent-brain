...
**Phases 4-5: pending.** Phase 4 moves the operating layer (prompts/skills/hooks) into Savant with export-to-disk; Phase 5 demotes git to a pure backing store. Each ships and verifies independently against production; can run interactively or as a build-loop task list ([[../../../agent-prompts/build-loop/SKILL.md]]).
