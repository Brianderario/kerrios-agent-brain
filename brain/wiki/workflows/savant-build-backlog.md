...
scope: workflow · updated: 2026-06-22 · owner: Brian + Kerri
...
| 3 | **Touches-per-dollar / deal activity metric** | 4 | The efficiency number the vision manages by; shows which deals are over-worked vs neglected. | Deal show page + deals index show a touch count (from `activity`/outreach records) and, on closed-won, touches-per-dollar; real activity only. | **proposed 2026-06-21, carried** (Brian didn't run it; rotated off 6/22 to avoid pitching the same thing two nights running; still undone, comes back around) |
| 4 | **Event/Kinetic sponsorship yield view** | 8 | Treats event prospectus tiers as sellable inventory like newsletter slots; shows sold/reserved/realized per tier. | An event-show section showing each sponsorship tier's sold/reserved selections + realized-vs-default $ (no invented capacity; sell-through = sold/reserved mix), from real `sponsorship_option`/`selection`/deal records; full-members-only for $. | **proposed 2026-06-22** |
